        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            <div className="relative">
              ...
              <h3 className="text-xl font-semibold mb-4">Consultoria gratuita</h3>
              <p className="text-neutral-600 mb-6">
                Fale com um engenheiro de sistemas real e discuta os requisitos e objetivos 
                do seu projeto. Ouviremos atentamente para entender sua visão e objetivos.
              </p>
            ...
            <div className="relative">
              ...
              <p className="text-neutral-600 mb-6">
                Com base na sua consulta, forneceremos um escopo detalhado, incluindo etapas 
                detalhadas, cronograma, orçamento e algumas possíveis modificações ou extensões 
                ao seu sistema.
              </p>
              <Button variant="link" className="text-accent-blue p-0 h-auto">
                Agendar uma chamada
            ...
            <div className="relative">
              ...
              <p className="text-neutral-600 mb-6">
                Com a proposta acertada, agendaremos uma reunião inicial para apresentar 
                nossa equipe e começarmos de verdade.
              </p>
              <Button variant="link" className="text-accent-blue p-0 h-auto">
                Agendar uma chamada
              </Button>
